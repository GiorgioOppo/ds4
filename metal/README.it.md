...
- `laguna/laguna_{quant,rope,kv,attention}.metal`: norm/RoPE per-testa Laguna,
  store KV ad anello F16, attention GQA gated (decode e prefill), reduce
  flash-attention gated e una proiezione densa Q6_K.
