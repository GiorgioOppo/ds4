...
ifeq ($(UNAME_S),Darwin)
.PHONY: metal-decode-schedule-bench metal-prefill-variant-bench metal-q4-dense-pair-bench metal-iq2-moe-tail-cull-bench check-mxfp4-half-lut test-mxfp4-metal
