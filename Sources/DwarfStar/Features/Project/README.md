...
- **`Views/ProjectView.swift`** manages the project library. It imports folders through
...
The view layer owns bookmark interaction and library presentation. Indexing,
querying, safe edits, path containment, and symlink refusal belong to
`DS4Engine.ProjectCache`. Preserve the different removal semantics above.
