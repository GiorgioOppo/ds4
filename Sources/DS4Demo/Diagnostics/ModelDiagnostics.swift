...
func knobReport() -> String {
    let knobs = ["DS4_DEMO_CONTEXT", "DS4_DEMO_LIVE_CONTEXT",
                 "DS4_KV_INITIAL",
                 "DS4_EXPERT_CACHE_SLOTS", "DS4_EXPERT_CACHE_MB",
                 ...
                 "DS4_EXPERT_LOOKAHEAD", "DS4_EXPERT_ASYNC_SPLIT",
                 "DS4_ASYNC_FFN", "DS4_ASYNC_ROUTE",
                 "DS4_PREFILL_UNION", "DS4_PREFILL_BATCH",
                 "DS4_PREFILL_MOE_BATCH", "DS4_PREFILL_FFN_BATCH",
                 "DS4_PREFILL_ROUTE_BATCH",
                 "DS4_PREFILL_CHUNK", "DS4_PREFILL_MM",
                 "DS4_PREFILL_ATTN_MULTIKEY", "DS4_PREFILL_LAST_ROW",
                 "DS4_DECODE_CHAINED", "DS4_DECODE_SPLIT_K",
                 "DS4_DECODE_SPLIT_K_MIN", "DS4_DECODE_SWA_GQA3",
                 "DS4_DECODE_FUSED_ROPE_KV", "DS4_ROPE_SIMD",
                 "DS4_DISCARD_UPLOAD_PAGES",
                 "DS4_RESIDENT_PRIVATE",
                 "DS4_EXPERT_CACHE_PARTITIONED",
                 "DS4_POOL_INTERLEAVE", "DS4_NSG", "DS4_Q8_NSG",
                 "DS4_MOE_NSG", "DS4_DENSE_Q4_NSG",
