...
extension ToolRegistry {
    ...
    static let githubClone = BuiltinTool(
        spec: ToolSpec(name: "github_clone",
                       description: "Download a PUBLIC GitHub repository (HTTPS tarball, no git needed) and import it as the ACTIVE project, replacing the current one. Returns a compact orientation summary. Then batch independent finds, searches, and relevant ranges with project_inspect — never read the whole repository.",
