...
extension ToolRegistry {
    ...
    static let fileRead = BuiltinTool(
        spec: ToolSpec(name: "file_read",
                       description: "Read any file inside the imported project root, even if it is not indexed. Without from_line/to_line, returns the whole file (96 KB cap); with from_line/to_line (1-based, inclusive), returns only those numbered lines.",
