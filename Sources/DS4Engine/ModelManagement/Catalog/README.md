...
|---|---|---|---|
| `q2-imatrix` | Flash 0730 | one Q2/IQ2XXS GGUF | `runnable` |
| `q2-imatrix-0731` | Flash 0731 | one Q2/IQ2XXS GGUF | `runnable` |
| `q2-q4-imatrix` | Flash 0730 | one mixed Q2/Q4 GGUF | `runnable` |
| `q2-q4-imatrix-0731` | Flash 0731 | one mixed Q2/Q4 GGUF | `runnable` |
| `q4-imatrix` | Flash 0730 | one Q4 GGUF | `runnable` |
| `q4-imatrix-0731` | Flash 0731 | one Q4 GGUF | `runnable` |
| `mxfp4-0731` | Flash 0731 | one native MXFP4 GGUF | `downloadOnly` |
...
MXFP4 is the quantization-specific exception: Flash geometry is supported, but
GGUF type 39 is kept download-only until its routed-expert Metal kernels and
block-size parser exist in Swift.
