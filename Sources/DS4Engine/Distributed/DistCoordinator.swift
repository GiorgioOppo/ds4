...
public final class DistCoordinator: @unchecked Sendable {
    ...
    private func handshakeAndTransfer(_ p: Peer, conn: DistConnection,
                                      offer: [DistFileEntry],
                                      onLog: @escaping @Sendable (String) -> Void) async throws {
    ...
    private var expertPeers: [(conn: DistConnection, mask: [Bool])] = []
    ...
    private var verticalEngine: DistEngine?
