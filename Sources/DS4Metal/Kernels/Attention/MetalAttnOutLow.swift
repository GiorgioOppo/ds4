...
extension MetalRuntime {
    ...
    static func attnLowArgs(nGroups: Int, groupDim: Int, rank: Int, rowABytes: Int,
                            blockBytes: Int = 34) -> [UInt8] {
        ...
        u64(32, UInt64(blockBytes)); u64(40, UInt64(rowABytes)); u64(48, UInt64(rank) * UInt64(rowABytes)) // nb00, nb01, nb02
