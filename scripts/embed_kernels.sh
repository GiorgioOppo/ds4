...
order="quant_tables flash_attn dense moe dsv4_hc unary dsv4_kv dsv4_rope dsv4_misc attn_out_fused q4_prefill_pair glm52_router glm52_quant glm52_kv glm52_indexer glm52_attention glm52_moe glm52_rope glm52_misc laguna_quant laguna_rope laguna_kv laguna_attention argsort cpy concat get_rows sum_rows softmax repeat glu norm bin set_rows"
