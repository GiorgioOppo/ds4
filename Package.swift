...
// one geometry-driven backend. Bonsai2, Qwen3.8, DeepSeek4.1 and GLM5.3 Flash
// have separate Swift/Metal decoders; other Qwen architectures and Kimi K3
// remain unavailable. The engine is pure Swift
// (DS4Core + DS4Metal): no
