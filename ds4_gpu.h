...
/* Optional Metal ratio-4 decode fusion. Returns 1 when both paired compressor
 * projections and their recurrent-state stores were encoded in one dispatch,
 * 0 when the caller should keep the separate paths, and -1 on an error. */
